...
console.log("Checking VCAP env");
if (process.env.VCAP_SERVICES) {
  console.log("VCAP env detected");
  var dbLabel = 'mongodb32';
...
module.exports = {
  mongodb: {
    ...
    auth: [
       ...
       */
      {
        database: process.env.ME_CONFIG_MONGODB_AUTH_DATABASE || mongo.default_database,
